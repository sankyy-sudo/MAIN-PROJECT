...
const Cart_1 = require("../modules/cart/models/Cart");
const CartItem_1 = require("../modules/cart/models/CartItem");
require("../modules/cms/models/AcademyWaitlist");
require("../modules/cms/models/Banner");
require("../modules/cms/models/CmsPage");
require("../modules/cms/models/ContentPost");
require("../modules/cms/models/SiteSetting");
require("../modules/commerce/models/CommerceSetting");
require("../modules/commerce/models/Coupon");
require("../modules/commerce/models/ShippingRule");
require("../modules/commerce/models/TaxSetting");
require("../modules/marketing/models/EmailAutomationLog");
require("../modules/marketing/models/MarketingCampaign");
require("../modules/marketing/models/NewsletterSubscriber");
...
Order_1.Order.hasOne(Payment_1.Payment, {
    as: "payment",
    foreignKey: "orderId",
    onDelete: "RESTRICT"
});
...
CartItem_1.CartItem.belongsTo(Cart_1.Cart, { foreignKey: "cartId" });
CartItem_1.CartItem.belongsTo(Product_1.Product, { as: "product", foreignKey: "productId" });
